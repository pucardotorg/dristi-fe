...
export const advHome = {
  ...
  causeListMineCount: t("{n} of these matters are yours, marked in teal", "ഇവയിൽ {n} കേസുകൾ നിങ്ങളുടേതാണ്, ടീലിൽ അടയാളപ്പെടുത്തി"),
  colItem: t("Item", "ഇനം"),
  colCase: t("Case", "കേസ്"),
  ...
  ongoingTag: t("Ongoing", "നടക്കുന്നു"),
  conflictTag: t("Conflict", "കൂട്ടിയിടി"),
